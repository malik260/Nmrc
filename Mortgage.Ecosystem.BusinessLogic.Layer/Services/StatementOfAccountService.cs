...
namespace Mortgage.Ecosystem.BusinessLogic.Layer.Services
{
    public class StatementOfAccountService : IStatementOfAccountService
    {
        ...
        public async Task<TData<List<StatementOfAccountEntity>>> GetList(StatementOfAccountListParam param)
        {
            TData<List<StatementOfAccountEntity>> obj = new TData<List<StatementOfAccountEntity>>();
        ...
        public async Task<TData<List<StatementOfAccountEntity>>> GetPageList(StatementOfAccountListParam param, Pagination pagination)
        {
            TData<List<StatementOfAccountEntity>> obj = new TData<List<StatementOfAccountEntity>>();
