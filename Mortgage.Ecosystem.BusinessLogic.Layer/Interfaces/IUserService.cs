...
namespace Mortgage.Ecosystem.BusinessLogic.Layer.Interfaces
{
    public interface IUserService
    {
        ...
        Task<TData<EmployeeEntity>> GetEntity(int id);
        ...
        Task<TData<UserEntity>> GetEntityByEmail(string username);
        Task<TData<long>> ResetPassword(UserEntity entity);
        Task<TData<long>> ChangePassword(ChangePasswordParam param);
        Task<TData<long>> ForgotPassword(ChangePasswordParam param);
