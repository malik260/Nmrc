...
namespace Mortgage.Ecosystem.DataAccess.Layer.Repositories
{
    public class LogOperateRepository : DataRepository, ILogOperateRepository
    {
        ...
        //    List<DbParameter> filter = ListFilters(param, strSql);
        ...
        //    return parameter;
        //}
        private Expression<Func<LogOperateEntity, bool>> ListFilters(LogOperateListParam param)
        {
            var expression = ExtensionLinq.True<LogOperateEntity>();
            if (param != null)
            {
                if (!string.IsNullOrEmpty(param.Company.ToStr()))
                {
                    //long companyValue = long.Parse(param.Company.ToStr());
