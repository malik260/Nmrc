        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductScheme = table.Column<int>(type: "int", nullable: false),
                    BaseCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BaseCreatorId = table.Column<long>(type: "bigint", nullable: false),
                    BaseProcessMenu = table.Column<long>(type: "bigint", nullable: false),
                    BaseVersion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lender = table.Column<long>(type: "bigint", nullable: false),
                    LenderTypeId = table.Column<int>(type: "int", nullable: true),
                    BaseCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BaseCreatorId = table.Column<long>(type: "bigint", nullable: false),
                    BaseProcessMenu = table.Column<long>(type: "bigint", nullable: false),
                    BaseVersion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_st_NmrcCategory", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "st_NmrcEligibility",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_st_NmrcEligibility", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LendersId = table.Column<long>(type: "bigint", nullable: false),
                    BaseCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BaseCreatorId = table.Column<long>(type: "bigint", nullable: false),
                    BaseProcessMenu = table.Column<long>(type: "bigint", nullable: false),
                    BaseVersion = table.Column<int>(type: "int", nullable: false),
