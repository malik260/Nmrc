...
namespace Mortgage.Ecosystem.Web.Controllers.Systems
{
    public class SubSectorController : BaseController
    {
        ...
        public SubSectorController(IUnitOfWork iUnitOfWork, ISubSectorService iSubSectorService, IAuditTrailService iAuditTrailService) : base(iUnitOfWork)
        {
        ...
        public async Task<IActionResult> GetSubSectorName(SubSectorListParam param)
        {
            ...
            auditInstance.Action = SystemOperationCode.GetSubSectorName.ToString();
            auditInstance.ActionRoute = SystemOperationCode.SubSector.ToString();
