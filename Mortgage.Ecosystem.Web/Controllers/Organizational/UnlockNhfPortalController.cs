...
namespace Mortgage.Ecosystem.Web.Controllers.Organizational
{
    public class UnlockNhfPortalController : BaseController
    {
        ...
        public UnlockNhfPortalController(IUnitOfWork iUnitOfWork, IUnlockNhfPortalService iUnlockNhfPortalService, IAuditTrailService iAuditTrailService) : base(iUnitOfWork)
        {
        ...
        public async Task<IActionResult> GetUnlockNhfPortalPageListJson(UnlockNhfPortalListParam param, Pagination pagination)
        {
            ...
            auditInstance.Action = SystemOperationCode.GetUnlockNhfPortalPageListJson.ToString();
            auditInstance.ActionRoute = SystemOperationCode.UnlockNHFPortal.ToString();
