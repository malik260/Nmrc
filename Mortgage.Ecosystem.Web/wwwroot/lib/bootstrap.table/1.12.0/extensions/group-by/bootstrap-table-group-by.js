...
!function ($) {
    ...
    var originalRowAttr,
        dataTTId = 'data-tt-id',
        dataTTParent = 'data-tt-parent',
        obj = {},
        parent = undefined;

    var getParentRowId = function (that, id) {
        var parentRows = that.$body.find('tr').not('[' + 'data-tt-parent]');
    ...
    var rowAttr = function (row, index) {
        ...
        if (!row.IsParent) {
            obj[dataTTParent.toString()] = parentId === undefined ? index : parent;
        } else {
            parent = index;
            delete obj[dataTTParent.toString()];
        }
