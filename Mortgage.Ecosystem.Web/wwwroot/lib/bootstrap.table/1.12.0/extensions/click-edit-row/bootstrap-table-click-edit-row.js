...
(function ($) {
    ...
    function updateToServerSide(item, data) {
        ...
        var datas = { 'treeId': itemid, 'oldTreeSerialNo': data[0], 'adminDivision': data[2], 'adminUnit': data[3], 'treeAddr': data[1] }; //Data generated to the server side, you need to manually modify the corresponding form
